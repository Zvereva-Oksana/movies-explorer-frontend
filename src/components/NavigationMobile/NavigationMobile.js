    ...
    return (
        isOpen
            ...
            <div className='popup'>
                <div className={`popup__container ${
                    ...
                    <button type="button" className={`popup__close-icon ${
                        currentPath === '/' ? `popup__close-icon_color` : ``}`} onClick={toggleMenu}/>
            ...
            : <div className={`navigation navigation_position ${
                ...
                <button type="button" className={`header__burger-icon ${
                    currentPath === '/' ? `header__burger-icon_color` : ``}`} onClick={toggleMenu}/>
            </div>
